...
conda create -n char_recog_new python=3.10
conda activate char_recog_new
...
print("\nModel Summary:")
print(f"Total trainable parameters: {count_parameters(network):,}")
print(f"Input shape: ({configs.height}, {configs.width}, 3)")
